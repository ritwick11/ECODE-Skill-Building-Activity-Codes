...
public:
 TestDescription_suite_test_testTwo() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 13, "testTwo" ) {}
...
public:
 TestDescription_suite_test_testThree() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 20, "testThree" ) {}
...
public:
 TestDescription_suite_test_testFour() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 27, "testFour" ) {}
...
public:
 TestDescription_suite_test_testFive() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 33, "testFive" ) {}
