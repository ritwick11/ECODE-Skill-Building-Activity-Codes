...
CxxTest::StaticSuiteDescription suiteDescription_SampleTestSuite( "test.h", 12, "SampleTestSuite", suite_SampleTestSuite, Tests_SampleTestSuite );
...
public:
 TestDescription_suite_SampleTestSuite_testTwo() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 25, "testTwo" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testFive() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 49, "testFive" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testSix() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 57, "testSix" ) {}
