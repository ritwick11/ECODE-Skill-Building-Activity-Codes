...
public:
 TestDescription_suite_test_testTwo() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 16, "testTwo" ) {}
...
public:
 TestDescription_suite_test_testThree() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 26, "testThree" ) {}
...
public:
 TestDescription_suite_test_testFour() : CxxTest::RealTestDescription( Tests_test, suiteDescription_test, 36, "testFour" ) {}
